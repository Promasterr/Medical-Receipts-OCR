...
#define calloc_with_usize JEMALLOC_N(calloc_with_usize)
#define free_default JEMALLOC_N(free_default)
#define free_with_usize JEMALLOC_N(free_with_usize)
...
#define malloc_with_usize JEMALLOC_N(malloc_with_usize)
...
#define realloc_with_usize JEMALLOC_N(realloc_with_usize)
